...
![nuget](https://img.shields.io/nuget/v/HighlightItem)
...
```ps
dotnet new install HighlightItem
```

## Create Project

Use JetBrains Rider or Visual Studio to create a new project from template. Fill in the necessary template information
in the advanced settings, or if you really want to use VSC:
